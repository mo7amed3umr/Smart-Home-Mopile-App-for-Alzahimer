...
import 'package:flutter_bluetooth_serial_example/reminder/src/common/convert_time.dart';
import 'package:flutter_bluetooth_serial_example/reminder/src/global_bloc.dart';
import 'package:flutter_bluetooth_serial_example/reminder/src/models/errors.dart';
import 'package:flutter_bluetooth_serial_example/reminder/src/models/medicine.dart';
import 'package:flutter_bluetooth_serial_example/reminder/src/models/medicine_type.dart';
import 'package:flutter_bluetooth_serial_example/reminder/src/ui/homepage/homepage.dart';
import 'package:flutter_bluetooth_serial_example/reminder/src/ui/new_entry/new_entry_bloc.dart';
import 'package:flutter_bluetooth_serial_example/reminder/src/ui/success_screen/success_screen.dart';
            ...
            child: Provider<NewEntryBloc>.value(
              ...
              child: ListView(
                ...
                children: <Widget>[
                  ...
                  Confirm(nameController, dosageController,
                      flutterLocalNotificationsPlugin, _newEntryBloc)
                ],
              ),
            ),
          ),
...
class Confirm extends StatelessWidget {
  ...
  Confirm(this.nameController, this.dosageController,
      this.flutterLocalNotificationsPlugin, this._newEntryBloc);
      ...
      child: Container(
        ...
        child: FlatButton(
          ...
          onPressed: () {
            ...
            //---------------------------------------------------------
            String medicineType = _newEntryBloc.selectedMedicineType.value
                .toString()
                .substring(13);
